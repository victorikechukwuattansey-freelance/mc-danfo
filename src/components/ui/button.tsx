  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-full text-sm font-semibold transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 cursor-pointer",
  {
    variants: {
      variant: {
        ...
        yellow:
          "bg-brand-yellow text-brand-black shadow-lg shadow-brand-yellow/30 hover:bg-brand-yellow-bright",
        whatsapp:
          "bg-[#25D366] text-white shadow-lg shadow-[#25D366]/30 hover:bg-[#1fbd5b]",
        dark: "bg-brand-black text-white hover:bg-brand-black/90",
        green:
          "bg-brand-green text-white shadow-lg shadow-brand-green/30 hover:bg-brand-green-light",
        whiteOutline:
